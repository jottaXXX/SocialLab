      ...
      <section id="contact" className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            {/* Contact Form */}
            <div>
              <h2 className="section-heading mb-8">Solicite sua Avaliação Gratuita</h2>
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="cta-button large w-full group"
                  >
                    Enviar Mensagem
            ...
            {/* Contact Info */}
            <div>
              <h3 className="section-heading mb-8">Outras Formas de Contato</h3>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">Atendimento presencial com agendamento</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-12 bg-gray-50 rounded-lg p-6">
                <h4 className="font-semibold mb-4">Por que escolher a SocialLab?</h4>
                <div className="space-y-3">
                  <div className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                    <span className="text-sm text-gray-600">Resposta em até 24 horas</span>
                  </div>
                  <div className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                    <span className="text-sm text-gray-600">Consultoria inicial gratuita</span>
                  </div>
                  <div className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                    <span className="text-sm text-gray-600">Mais de 150 projetos entregues</span>
                  </div>
                  <div className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3" />
                    <span className="text-sm text-gray-600">98% de satisfação dos clientes</span>
                  </div>
                </div>
              </div>
            </div>
